...
const PKG_COLORS: any = {
  ...
  silver:"border-emerald-500/40 text-emerald-400",
...
const ALL_MODULES = [
  ...
  {id:"s4",level:1,pkgLabel:"Silver",icon:"",tag:"Manajemen Risiko",title:"Risk & Money Management Lanjutan",
  ...
  {id:"p2",level:3,pkgLabel:"Pro",icon:"",tag:"Watchlist",title:"Watchlist & Screening Personal Pro",
  ...
  {id:"g5",level:2,pkgLabel:"Gold",icon:"",tag:"Teknikal",title:"Candlestick Pattern Lanjutan",
  ...
  {id:"g7",level:2,pkgLabel:"Gold",icon:"〰",tag:"Teknikal",title:"Elliot Wave Theory Dasar",
  ...
  {id:"pl4",level:4,pkgLabel:"Platinum",icon:"",tag:"Fundamental",title:"Analisis Arus Kas Lanjutan & DCF",
  ...
  {id:"pl5",level:4,pkgLabel:"Platinum",icon:"",tag:"Fundamental",title:"Special Situations: IPO, Rights Issue & Akuisisi",
  ...
  {id:"e6",level:5,pkgLabel:"Elite",icon:"",tag:"Fundamental",title:"Analisis BUMN & Emiten Pemerintah",
  ...
  {id:"ban1",level:2,pkgLabel:"Gold",icon:"",tag:"Bandarmologi",title:"Panduan Lengkap: Cara Kerja Bandar",
  ...
  {id:"ta3",level:2,pkgLabel:"Gold",icon:"",tag:"Teknikal",title:"Advanced Candlestick Pattern",
  ...
  {id:"ta9",level:4,pkgLabel:"Platinum",icon:"",tag:"Teknikal",title:"Wyckoff Method di Pasar BEI",
  ...
  {id:"fa2",level:1,pkgLabel:"Silver",icon:"",tag:"Fundamental",title:"Analisis Sektoral: Tambang & Energi",
  ...
  {id:"fa3",level:1,pkgLabel:"Silver",icon:"",tag:"Fundamental",title:"Analisis Sektoral: Properti & Konstruksi",
  ...
  // ===== MANAJEMEN RISIKO =====
  {id:"rm1",level:0,pkgLabel:"Basic",icon:"",tag:"Manajemen Risiko",title:"Prinsip Dasar Manajemen Risiko",
  ...
  {id:"rm2",level:1,pkgLabel:"Silver",icon:"",tag:"Manajemen Risiko",title:"Position Sizing yang Benar",
  ...
  {id:"psy2",level:1,pkgLabel:"Silver",icon:"",tag:"Psikologi",title:"Bias Kognitif yang Merusak Keputusan",
  ...
  {id:"psy5",level:3,pkgLabel:"Pro",icon:"",tag:"Psikologi",title:"Disiplin Sistem & Mental Toughness",
  ...
  {id:"bnd1",level:1,pkgLabel:"Silver",icon:"",tag:"Bandarmologi",title:"Broker Summary: Tracking Big Player",
  ...
  {id:"bnd6",level:4,pkgLabel:"Platinum",icon:"",tag:"Bandarmologi",title:"Analisis Kepemilikan & Insider Transaction",
  ...
  {id:"pm1",level:0,pkgLabel:"Basic",icon:"",tag:"Portofolio",title:"Membangun Portofolio Pertama",
  ...
  // ===== TOOLS & PLATFORM =====
  {id:"tl1",level:0,pkgLabel:"Basic",icon:"",tag:"Tools",title:"Platform & Tools Wajib Investor BEI",
  ...
  {id:"tl3",level:2,pkgLabel:"Gold",icon:"",tag:"Tools",title:"TradingView Advanced: Setup Profesional",
  ...
  {id:"sp4",level:2,pkgLabel:"Gold",icon:"",tag:"Special",title:"Saham BUMN: Karakteristik & Cara Analisis",
...
const TAG_COLORS: any = {
  ...
  "AI Agent":"bg-emerald-500/10 text-emerald-400","Watchlist":"bg-indigo-500/10 text-indigo-400",
  "Laporan":"bg-yellow-500/10 text-yellow-400","Konsultasi":"bg-teal-500/10 text-teal-400",
  "AI Advanced":"bg-emerald-500/10 text-emerald-400","Sinyal":"bg-green-500/10 text-green-400",
...
export default function VipPage() {
  ...
  return (
    <div style={{ fontFamily:"'Inter',sans-serif", background:"#030712", color:"#fff", minHeight:"100vh", display:"flex", flexDirection:"column", position:"relative" }}>
      ...
      <div style={{ position:"sticky", top:0, zIndex:50, background:"rgba(3,5,8,0.88)", backdropFilter:"blur(12px)", WebkitBackdropFilter:"blur(12px)", borderBottom:"1px solid rgba(255,255,255,0.055)", flexShrink:0 }}>
        <JakartaClock />
        <MotivasiTickerVIP />
                            ...
                            {MODULE_CONTENT[m.id].lessons.map((lesson:any, li:number)=>(
                              <div key={li} className="bg-white/3 border border-white/8 rounded-xl p-4">
                                <div className="flex items-center gap-2 mb-2">
                                  <span className="w-5 h-5 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 text-xs font-black flex items-center justify-center flex-shrink-0">{li+1}</span>
